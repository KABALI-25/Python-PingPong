...
def hit_paddle():
    if x - r <= paddle_x + paddle_width and y > paddle_y and y < paddle_y + paddle_height:
        return True
    return False
...
welcome = welcome_screen.render("Lets Play Pong", True, (255, 255, 255))
...
while True:
    ...
    pygame.draw.circle(display, (255, 255, 255), (x, y), r)
    if x < r:
        game_over()
        x = 250
        y = 250
